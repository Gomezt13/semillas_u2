...
![*Figura 1*. Efecto de tratamientos hormonales y térmicos sobre el número de semillas germinadas de garbanzo (*Cicer arietinum* L..](figure1.jpg)
...
![*Figura 2*. Efecto de tratamientos hormonales y térmicos sobre el tiempo medio de germinación en semillas de garbanzo (*Cicer arietinum* L.)](figure2.jpg)
...
El presente estudio evaluó el impacto de dos tratamientos en la germinación de semillas de garbanzo (Cicer arietinum L.): un tratamiento hormonal con giberelina (GA) y un tratamiento térmico mediante la exposición de las semillas a agua a 80°C durante 5 minutos. La comparación de estos tratamientos con un grupo control permitió analizar las diferencias en el porcentaje de germinación, el tiempo promedio de germinación, el índice de sincronización y la germinabilidad de las semillas.

Los resultados obtenidos mostraron que, en cuanto a semillas germinadas, no hubo diferencias estadísticamente significativas entre los tratamientos. Aunque el tratamiento térmico presentó una media ligeramente superior, esta diferencia no fue suficiente para que se considerara significativa. Esto sugiere que ambos tratamientos, hormonal y térmico, tienen un efecto similar en la capacidad de las semillas para germinar. Sin embargo, el análisis de la distribución y variabilidad de los datos mediante boxplots reveló que el tratamiento térmico presentó una menor dispersión, indicando una mayor homogeneidad en la germinación de las semillas.

En términos de tiempo promedio de germinación, aunque no se encontraron diferencias estadísticas significativas entre los tratamientos, el tratamiento térmico mostró una tendencia a acelerar la germinación, lo que podría ser indicativo de su efectividad para romper la dormancia de las semillas de manera más rápida y eficiente. Este hallazgo concuerda con estudios previos que han sugerido que el tratamiento térmico puede ser útil para disminuir el tiempo de germinación en algunas leguminosas.

En relación al índice de sincronización, los tratamientos testigo y hormonal mostraron valores medios de sincronización más elevados, lo que sugiere que la germinación en estos tratamientos fue más uniforme. Por otro lado, el tratamiento térmico, aunque con una mediana más baja, mostró una germinación menos sincronizada, lo que indica que el calor aplicado podría generar una mayor dispersión en los tiempos de germinación. Sin embargo, como en los otros análisis, las diferencias no fueron estadísticamente significativas, lo que señala que la sincronización de la germinación no varió considerablemente entre los tratamientos.

Finalmente, en cuanto a la germinabilidad, el tratamiento térmico presentó el mayor porcentaje de germinación, seguido por el tratamiento hormonal, con el control teniendo el valor más bajo. Aunque esta diferencia visual fue notable, no se encontraron diferencias estadísticas significativas, lo que indica que, a pesar de la tendencia a una mayor germinabilidad en el tratamiento térmico, los resultados pueden estar influenciados por la variabilidad inherente al proceso de germinación.

##	CONCLUSIONES 

En conclusión, los resultados de este estudio indican que tanto el tratamiento hormonal con giberelina como el tratamiento térmico son efectivos para la germinación de semillas de garbanzo, sin embargo, no se encontraron diferencias estadísticamente significativas entre ellos en los parámetros evaluados. Ambos tratamientos mostraron ser similares en su capacidad para inducir la germinación, aunque el tratamiento térmico presentó una mayor homogeneidad y una ligera tendencia a acelerar el proceso de germinación.

El tratamiento térmico podría ser más adecuado en condiciones en las que se necesite una germinación rápida y uniforme, mientras que el tratamiento hormonal con giberelina también presenta beneficios, especialmente en términos de sincronización. Es recomendable realizar estudios adicionales con un mayor número de repeticiones y condiciones variables para confirmar la efectividad de estos tratamientos y su aplicabilidad a gran escala en la producción de garbanzo.
